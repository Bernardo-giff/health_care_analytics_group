...
# Create a new flag variable for straight orientation
data <- data %>%
  mutate(
    SEX = as.character(SEX),
    SEXSEX = as.character(SEXSEX),
    flg_is_straight = ifelse(
      (SEX == "MALE" & SEXSEX == "EXCLUSIVELY FEMALE") |
      (SEX == "FEMALE" & SEXSEX == "EXCLUSIVELY MALE"),
      1, 0
    )
  )

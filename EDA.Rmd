...
# Show labels of EDUC
#educ_labels <- attr(data$EDUC, "labels")
...
#data$EDUC <- factor(data$EDUC, levels = 0:20, labels = education_levels[1:21])
#data$EDUC[data$EDUC == 98] <- "Don't know"
#data$EDUC[data$EDUC == 99] <- "No answer"

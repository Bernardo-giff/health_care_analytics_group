...
sliced_data <- raw_data %>%
  select(
    ...
    #, HEALTH1 #R'S HEALTH IN GENERAL                                                           Too many NAS
    #, HLTHCOVR #R HAS HEALTH INSURANCE COVERAGE                                                Too many NAS
    #, HLTHINSR #HAVE HEALTH INSURANCE                                                          Too many NAS
    #, MNTLDIF #HOW DIFFICULT TO GET MENTAL HEALTH CARE                                         Too many NAS
    #, MHTREATD #R EVER TREATED FOR MH PROBLEM                                                  Too many NAS
    #, SMOKE #DOES R SMOKE                                                                      Too many NAS
    #, DRINK #EVER DRINK ALCOHOLIC BEVERAGES?                                                   Too many NAS
    #, SLPPRBLM #TROUBLE SLEEPING LAST 12 MONTHS                                                Too many NAS
    , EDUC #HIGHEST YEAR OF SCHOOL COMPLETED                                      
    #, JOBKEEP #JOB SECURITY                                                                    Too many NAS
    #, JOBSEC #NO DANGER OF BEING FIRED                                                         Too many NAS
...
sliced_data <- filtered_data %>%
  select(
    ...
    , JOBSEC #NO DANGER OF BEING FIRED //// Both job sec var have most missing values 
    , SPWRKSTA #SPOUSE LABOR FORCE STATUS
    , MARITAL #MARITAL STATUS
  )
